...
print("="*70)
print("HYPERPARAMETER OPTIMIZATION - NESTED CV (EGFR)")
print("="*70)

print("\n1. Loading data...")

df = pd.read_csv('/kaggle/input/datasets/yanny1/egfr-full-model-results/caspid_conditioning_data.csv')
...
try:
    weights_file = '/kaggle/input/datasets/yanny1/egfr-full-model-results/conditioning_weights.npy'
