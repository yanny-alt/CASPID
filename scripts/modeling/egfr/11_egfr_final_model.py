...
Saves model for MEK validation and generates predictions for interpretation.
...
RESULTS_DIR = PROJECT_ROOT / "results" / "egfr"
...
print("="*70)
print("FINAL EGFR MODEL TRAINING - PRIMARY VALIDATION")
print("="*70)
...
cell_lines = df['CELL_LINE_NAME'].values if 'CELL_LINE_NAME' in df.columns else None
...
opt_file = MODELING_DIR / "hyperparameter_optimization" / "optimization_summary.json"
...
log(f"\n✓ Ready for MEK cross-target validation")
log("="*70)
