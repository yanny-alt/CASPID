...
print("="*70)
print("CONSENSUS FEATURE SELECTION - EGFR")
print("="*70)
...
binding_patterns = {
    'hinge': ['hinge_TRP793'],
    'gatekeeper': ['gatekeeper_LEU790'],
    'catalytic_lys': ['catalytic_lys_LYS721'],
    'dfg': ['dfg_ASP831', 'dfg_PHE832', 'dfg_GLY833'],
    'c_helix': ['c_helix_GLU738'],
    'p_loop': ['p_loop_GLY695', 'p_loop_GLY697']
}
