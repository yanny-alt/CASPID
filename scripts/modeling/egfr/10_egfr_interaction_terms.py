...
print("="*70)
print("INTERACTION TERM SELECTION - EGFR")
print("="*70)
...
import pickle
optimized_model_file = MODELING_DIR / "hyperparameter_optimization" / "caspid_optimized_final.pkl"
...
if optimized_model_file.exists():
    ...
    optimal_params = {
        'n_estimators': 200,   # ✅ Correct
        'max_depth': 6,        # ✅ Correct (was 6 for EGFR, not 8!)
        'learning_rate': 0.1,  # ✅ Correct
        'subsample': 0.8,      # ✅ Correct
        'colsample_bytree': 0.8,  # ✅ Correct
        'reg_alpha': 0.1,      # ✅ Correct
        'reg_lambda': 1.0      # ✅ Correct
    }
...
log("Total possible interactions: 48 × 105 = 5,040")
