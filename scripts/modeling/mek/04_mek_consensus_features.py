...
print("="*70)
print("CONSENSUS FEATURE SELECTION - MEK")
print("="*70)
...
binding_patterns = {
    'hinge': ['hinge_MET143', 'hinge_GLY144', 'hinge_ASP147'],
    'gatekeeper': ['gatekeeper_ILE141'],
    'dfg': ['dfg_ASP208', 'dfg_PHE209', 'dfg_GLY210'],
    'p_loop': ['p_loop_GLY77', 'p_loop_GLY79', 'p_loop_SER80'],
    'c_helix': ['c_helix_GLU114'],
    'catalytic_lys': ['catalytic_lys_LYS97'],
    'a_loop': ['a_loop_SER218', 'a_loop_SER222'],
    'allosteric': ['allosteric_VAL127', 'allosteric_TYR130', 'allosteric_CYS207']
}
